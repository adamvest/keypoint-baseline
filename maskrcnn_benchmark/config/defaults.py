...
_C.MODEL.ROI_SHAPE_CLASS_HEAD = CN()
_C.MODEL.ROI_SHAPE_CLASS_HEAD.FEATURE_EXTRACTOR = "ResNet50Conv5ROIFeatureExtractor"
_C.MODEL.ROI_SHAPE_CLASS_HEAD.PREDICTOR = "ShapeClassMaskRCNNC4Predictor"
_C.MODEL.ROI_SHAPE_CLASS_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_SHAPE_CLASS_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_SHAPE_CLASS_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_SHAPE_CLASS_HEAD.CONV_LAYERS = (256, 256, 256, 256)
_C.MODEL.ROI_SHAPE_CLASS_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = True
_C.MODEL.ROI_SHAPE_CLASS_HEAD.NUM_POLYGON_TYPES = 3
_C.MODEL.ROI_SHAPE_CLASS_HEAD.DILATION = 1
_C.MODEL.ROI_SHAPE_CLASS_HEAD.USE_GN = False
